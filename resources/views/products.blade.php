            ...
            <div class="relative block flex flex-col md:flex-row items-center">
                <div class="w-11/12 max-w-sm sm:w-3/5 lg:w-1/3 sm:my-5 my-8 relative z-0 rounded-lg shadow-lg md:-mr-4">
                    <div class="bg-white text-black rounded-lg shadow-inner shadow-lg overflow-hidden">
                        <div class="block text-left text-sm sm:text-md max-w-sm mx-auto mt-2 text-black px-8 lg:px-6">
                            ...
                            <h2 class="text-sm text-gray-500 text-center pb-6">Rp. 75.000</h2>
                        ...
                        <div class="block flex items-center p-8">
                            <a class="mt-3 text-lg text-center font-semibold bg-yellow-400 w-full text-black rounded-lg px-6 py-3 block hover:bg-black hover:text-yellow-400" href="/select/hobby">
                                Select
                            </a>
                        </div>
                    </div>
                ...
                <div class="w-full max-w-md sm:w-2/3 lg:w-1/3 sm:my-5 my-8 relative z-10 bg-white rounded-lg shadow-lg">
                    ...
                    <div class="block text-left text-sm sm:text-md max-w-sm mx-auto mt-2 text-black px-8 lg:px-6">
                        ...
                        <h2 class="text-sm text-gray-500 text-center pb-6"><span class="text-3xl">Rp. 300.000</span> /mo</h2>
                    ...
                    <div class="block flex items-center p-8">
                        <a class="mt-3 text-lg font-semibold text-center bg-yellow-500 w-full text-black rounded-lg px-6 py-3 block hover:bg-black hover:text-yellow-500" href="/select/expert">
                            Select
                        </a>
                    </div>
                </div>
                <div class="w-11/12 max-w-sm sm:w-3/5 lg:w-1/3 sm:my-5 my-8 relative z-0 rounded-lg shadow-lg md:-ml-4">
                    <div class="bg-white text-black rounded-lg shadow-inner shadow-lg overflow-hidden">
                        <div class="block text-left text-sm sm:text-md max-w-sm mx-auto mt-2 text-black px-8 lg:px-6">
                            ...
                            <h2 class="text-sm text-gray-500 text-center pb-6">Rp. 1.200.000 /mo</h2>
                        ...
                        <div class="block flex items-center p-8">
                            <a class="mt-3 text-lg font-semibold text-center bg-yellow-400 w-full text-black rounded-lg px-6 py-3 block hover:bg-black hover:text-yellow-400" href="/select/enteprise">
                                Select
                            </a>
                        </div>
                    </div>
